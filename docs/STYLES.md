...
![wave](screenshots/menu.png)

Style file: [`examples/styles/wave.style`](../examples/styles/wave.style)

## Table of Contents

**Community Styles** (10) — [Carbonit](#carbonit) | [Neon](#neon) | [Soft White](#soft-white) | [Raven](#raven) | [Graphite](#graphite) | [Clear](#clear) | [Plastick](#plastick) | [Black Glass](#black-glass) | [Coffee Dream](#coffee-dream) | [blackdelux](#blackdelux)

**Upstream Styles — Pixmap** (13) — [arch](#arch) | [bloe](#bloe) | [BlueFlux](#blueflux) | [bora_black](#bora_black) | [bora_blue](#bora_blue) | [bora_green](#bora_green) | [carp](#carp) | [Emerge](#emerge) | [green_tea](#green_tea) | [ostrich](#ostrich) | [zimek_bisque](#zimek_bisque) | [zimek_darkblue](#zimek_darkblue) | [zimek_green](#zimek_green)

**Upstream Styles — Gradient/Solid** (14) — [Artwiz](#artwiz) | [BlueNight](#bluenight) | [Flux](#flux) | [LemonSpace](#lemonspace) | [Makro](#makro) | [MerleyKay](#merleykay) | [Meta](#meta) | [Nyz](#nyz) | [Operation](#operation) | [Outcomes](#outcomes) | [qnx-photon](#qnx-photon) | [Results](#results) | [Shade](#shade) | [Twice](#twice)

**Reference** — [Using Styles](#using-styles) | [Style Rendering Support](#style-rendering-support)
...
[`examples/styles/community/Carbonit/`](../examples/styles/community/Carbonit/)
...
[`examples/styles/community/Neon/`](../examples/styles/community/Neon/)
...
[`examples/styles/community/Soft_White/`](../examples/styles/community/Soft_White/)
...
[`examples/styles/community/Raven/`](../examples/styles/community/Raven/)
...
[`examples/styles/community/Graphite/`](../examples/styles/community/Graphite/)
...
[`examples/styles/community/Clear/`](../examples/styles/community/Clear/)
...
[`examples/styles/community/Plastick/`](../examples/styles/community/Plastick/)
...
[`examples/styles/community/Black_glass/`](../examples/styles/community/Black_glass/)
...
[`examples/styles/community/CoffeeDream/`](../examples/styles/community/CoffeeDream/)
...
[`examples/styles/community/blackdelux/`](../examples/styles/community/blackdelux/)
...
[`examples/styles/upstream/arch/`](../examples/styles/upstream/arch/)
...
[`examples/styles/upstream/bloe/`](../examples/styles/upstream/bloe/)
...
[`examples/styles/upstream/BlueFlux/`](../examples/styles/upstream/BlueFlux/)
...
[`examples/styles/upstream/bora_black/`](../examples/styles/upstream/bora_black/)
...
[`examples/styles/upstream/bora_blue/`](../examples/styles/upstream/bora_blue/)
...
[`examples/styles/upstream/bora_green/`](../examples/styles/upstream/bora_green/)
...
[`examples/styles/upstream/carp/`](../examples/styles/upstream/carp/)
...
[`examples/styles/upstream/Emerge/`](../examples/styles/upstream/Emerge/)
...
[`examples/styles/upstream/green_tea/`](../examples/styles/upstream/green_tea/)
...
[`examples/styles/upstream/ostrich/`](../examples/styles/upstream/ostrich/)
...
[`examples/styles/upstream/zimek_bisque/`](../examples/styles/upstream/zimek_bisque/)
...
[`examples/styles/upstream/zimek_darkblue/`](../examples/styles/upstream/zimek_darkblue/)
...
[`examples/styles/upstream/zimek_green/`](../examples/styles/upstream/zimek_green/)
...
[`examples/styles/upstream/Artwiz`](../examples/styles/upstream/Artwiz)
...
[`examples/styles/upstream/BlueNight`](../examples/styles/upstream/BlueNight)
...
[`examples/styles/upstream/Flux`](../examples/styles/upstream/Flux)
...
[`examples/styles/upstream/LemonSpace`](../examples/styles/upstream/LemonSpace)
...
[`examples/styles/upstream/Makro`](../examples/styles/upstream/Makro)
...
[`examples/styles/upstream/MerleyKay`](../examples/styles/upstream/MerleyKay)
...
[`examples/styles/upstream/Meta`](../examples/styles/upstream/Meta)
...
[`examples/styles/upstream/Nyz`](../examples/styles/upstream/Nyz)
...
[`examples/styles/upstream/Operation`](../examples/styles/upstream/Operation)
...
[`examples/styles/upstream/Outcomes`](../examples/styles/upstream/Outcomes)
...
[`examples/styles/upstream/qnx-photon`](../examples/styles/upstream/qnx-photon)
...
[`examples/styles/upstream/Results`](../examples/styles/upstream/Results)
...
[`examples/styles/upstream/Shade`](../examples/styles/upstream/Shade)
...
[`examples/styles/upstream/Twice`](../examples/styles/upstream/Twice)
